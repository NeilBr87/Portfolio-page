...
export default function AboutMe(props) {
    ...
    return (
        ...
        borderRadius: '10px'}}>
            ...
            <Typography sx={{fontWeight: isMobile? '500' : 'bold', pb: isMobile? '7px' : '16px', fontSize: isMobile? '0.7rem': '1rem', textAlign: isMobile? 'center' : 'center'}} className="aboutText">I recently completed a full-stack development course at the School of Code and am looking to begin my career in tech. I'm fascinated by the chance to use creativity and problem-solving to make a difference.</Typography>
