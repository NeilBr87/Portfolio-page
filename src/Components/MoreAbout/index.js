        ...
        <Box>
            ...
            <Box sx={{display: 'flex', flexDirection: isMobile? 'column' : 'row', justifyContent: 'center', alignItems: isMobile? 'center' :  'flex-start', gap: '40px', mt: '30px'}}>
                ...
                <Box sx={{backgroundColor: '#003049', color: 'white', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center', width: isMobile? '350px' : '800px', borderRadius: '10px', boxShadow: '0px 3px 5px rgba(0.5, 0.5, 0.7, 0.7)'}}>
                    ...
                    <Typography sx={{fontSize: isMobile? '14px' : '16px', width: isMobile? '330px' : '700px', textAlign: 'center', mt: isMobile? '10px' : '20px'}}>While I've never had a job in development, I think that the experience I've gained in my professional career will be of benefit - both to me and a future employer.</Typography>
                    <Typography sx={{fontSize: isMobile? '14px' : '16px', width: isMobile? '330px' : '700px', textAlign: 'center', mt: isMobile? '10px' : '20px'}}>Before joining the School of Code, I spent the last four and a half years working for the Independent Schools Inspectorate. As an Account Officer, I was responsible for the core aim of the organisation - organising and managing inspections for 1,400 Independent Schools Association schools. As a member of the small but dedicated Delivery Team, I was responsible for managing these inspections from end to end. That meant everything from choosing and inviting the initial team, liaising with them to provide inspection documentation and answer logistical questions, booking accomodation, notifying and liaising with the school, and progressing and proofreading inspection reports. </Typography>
                    <Typography sx={{fontSize: isMobile? '14px' : '16px', width: isMobile? '330px' : '700px', textAlign: 'center', mt: isMobile? '10px' : '20px'}}>While my team and I worked in close cohesion to ensure a thorough inspection cycle for routine inspections, as the most senior member of the team I had individual responsibility for short visits. These were one-day, ad hoc inspections outside of the usual timeframe that were either organised due to reported concerns outside of the inspection schedule, or to check the progress of school action plan implementation. </Typography>
                    <Typography sx={{fontSize: isMobile? '14px' : '16px', width: isMobile? '330px' : '700px', textAlign: 'center', mt: isMobile? '10px' : '20px'}}>I am proud of the reputation I developed for fast, efficient inspection management, both among inspectors and school headteachers. I had to be a strong communicator and be able to pre-empt problems on my side long before an inspection took place. </Typography>
                    <Typography sx={{fontSize: isMobile? '14px' : '16px', width: isMobile? '330px' : '700px', textAlign: 'center', mt: isMobile? '10px' : '20px'}}>I'm eager to talk more about ISI and my other roles, but the UI designer in me says that this wall of text shouldn't be too much bigger! So please see my CV via the navbar for more.</Typography>
                </Box>
